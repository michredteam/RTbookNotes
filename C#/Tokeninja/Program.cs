...
namespace Tokeninja
{
 ...
 _________     ___     ___  ____    ________   ____  _____     ____  _____   _____   ____  _____      _____        _       
|  _   _  |  .'   `.  |_  ||_  _|  |_   __  | |_   \|_   _|   |_   \|_   _| |_   _| |_   \|_   _|    |_   _|      / \      
|_/ | | \_| /  .-.  \   | |_/ /      | |_ \_|   |   \ | |       |   \ | |     | |     |   \ | |        | |       / _ \     
    | |     | |   | |   |  __'.      |  _| _    | |\ \| |       | |\ \| |     | |     | |\ \| |    _   | |      / ___ \    
   _| |_    \  `-'  /  _| |  \ \_   _| |__/ |  _| |_\   |_     _| |_\   |_   _| |_   _| |_\   |_  | |__' |    _/ /   \ \_  
  |_____|    `.___.'  |____||____| |________| |_____|\____|   |_____|\____| |_____| |_____|\____| `.____.'   |____| |____| 
...
Console.WriteLine("\r\n===============================  Tool Menu ===============================\r\n");
            ...
            Console.WriteLine("1. List user processes");
            Console.WriteLine("   Command: Tokeninja.exe list");
            Console.WriteLine("   Description: Lists all processes run by the current user.\r\n");

            Console.WriteLine("2. List user processes via WMI");
            Console.WriteLine("   Command: Tokeninja.exe list wmi");
            Console.WriteLine("   Description: Lists all user processes using Windows Management Instrumentation (WMI).\r\n");

            Console.WriteLine("3. List only elevated processes");
            Console.WriteLine("   Command: Tokeninja.exe list elevated");
            Console.WriteLine("   Description: Lists only the processes with elevated privileges.\r\n");

            Console.WriteLine("4. Impersonate the first process of a user to start a new binary");
            Console.WriteLine("   Command: Tokeninja.exe user:<user> binary:<binary-Path>");
            Console.WriteLine("   Description: Impersonates the first process of the specified user and starts a new binary executable.\r\n");

            Console.WriteLine("5. Inject shellcode into the first process of a user");
            Console.WriteLine("   Command: Tokeninja.exe user:<user> shellcode:<base64shellcode>");
            Console.WriteLine("   Description: Injects base64-encoded shellcode into the first process of the specified user.\r\n");

            Console.WriteLine("6. Impersonate a process with a specific PID and start a binary");
            Console.WriteLine("   Command: Tokeninja.exe pid:<ID> binary:<binary-Path>");
            Console.WriteLine("   Description: Impersonates the process with the given PID and starts a new binary executable.\r\n");

            Console.WriteLine("7. Impersonate a user to use their token for the current process (NtSetInformationThread)");
            Console.WriteLine("   Command: Tokeninja.exe user:<user> technique:ImpersonateLoggedOnuser");
            Console.WriteLine("   Description: Uses the token of the specified user to impersonate them in the current process.\r\n");
